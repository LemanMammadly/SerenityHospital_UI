...
//                   )}
//                 <button type="submit">
//                   Sign Up <i className="fa-solid fa-check"></i>
//                 </button>
//               </div>
//             </div>
//           </form>
        ...
        >
          <div class="form-input-register">
            ...
            {errorMessages.ImageFile ? (
              ...
              <div className="error-messages">
                <p className="error-message">
                  {exception && exception.includes("image") ? exception : ""}
                </p>
              </div>
            )}
            <div class="btn-input-register d-flex align-items-center justify-content-center">
